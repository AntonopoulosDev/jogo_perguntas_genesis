...
def carregar_perguntas():
    with open('questions/very_hard_questions.json', 'r', encoding='utf-8') as file:
...
def salvar_perguntas(perguntas):
    with open('questions/very_hard_questions.json', 'w', encoding='utf-8') as file:
...
def show_very_hard_question(root, jogador_escolhido=None, dificuldade=None, dificult=None):
